...
public class Main {
    ...
    public static void main(String[] args) {
        Cliente p1=new Particular("Pedro Lopez","4856433","San Juan 2121");
        Cliente p2=new Particular("Maria Fernandez","46675464","San Martin 2221");
        Cliente e1=new Empresa("Delta Computacion","6456414","San Lorenzo 3131");
        Cliente e2=new Empresa("Luro Autohogar","6584668","Juan b justo 321");
